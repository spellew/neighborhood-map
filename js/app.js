// window.onload ensures that all of the necessary scripts and styles for our app
// are loaded in before it runs.
window.onload = () => {
  ...
  // API, and we receive points of interests near the user. If there are points
  ...
  const ViewModel = function() {
    ...
    self.redrawMarkers = () => {
      ...
      self.filteredLocations().forEach(location => {
        ...
        }).setContent(location.photo ? `<figure>
